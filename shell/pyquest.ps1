...
function uninstall {
    ...
    'pq pyquest begin menu back status help setup textbook ref check hint solution map stats score next goto load skip retry replay revert mode theme user users reset uninstall'.Split(' ') |
